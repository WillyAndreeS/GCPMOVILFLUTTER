...
class GaleriaCapas extends StatefulWidget {
  String? titulo;
  GaleriaCapas({Key? key, this.titulo}) ;

  @override
  _GaleriaCapasState createState() => _GaleriaCapasState();
}

class _GaleriaCapasState extends State<GaleriaCapas> {
  late Size size;
  List galeriaF = [];
  List arandanoF = [];
  List videos = [];
  ...
  /*Future<void> getGaleriaCapas(String menu) async{
  ...
  Widget build(BuildContext context) {
    ...
    child: Column(children: [
      Container(width:size.width,child: Text("FOTOS Y VIDEOS - ACP", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Schyler", color: Colors.black, fontSize: 20),)),
      SizedBox(height: 10,),
      ...
      selectedColor: Colors.white,textStyle: TextStyle(fontWeight: FontWeight.bold),color: Colors.black,fillColor: kPrimaryColor,children:[
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 10), child: Text("ECOIN", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Schyler", fontSize: 12),)),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 10), child: Text("FEEDBACK", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Schyler", fontSize: 12),)),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 10), child: Text("AMAR LO QUE HACES", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Schyler", fontSize: 12),)),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 10), child: Text("DIVERTICHAMBA", textAlign: TextAlign.center,style: TextStyle(fontFamily: "Schyler", fontSize: 12),))
        ],
        ...
        ,))),),
      galeriaF.isEmpty ? Container(width:size.width, height: size.height/1.4, child: Center(child: CircularProgressIndicator())): Container( width:size.width, height: size.height/1.4
     /* ListView.builder(
