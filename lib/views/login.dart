...
class _LoginState extends State<Login> {
  ...
  Future<void> getMenus()  async {
    var usuariosF = FirebaseFirestore.instance.collection("menu").doc(empresaUsuario).collection(tipoUsuario!);
  ...
  void getUsers(dni, pass) async{
    ...
    if(users.docs.isNotEmpty){
      ...
      tipoUsuario = "obrero";
      datosUsuario(nombreUsuario, dniUsuario, empresaUsuario, tipoUsuario);
      await getMenus();
      await getMenusgcp();
