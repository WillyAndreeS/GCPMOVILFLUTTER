                    ...
                    return GestureDetector(
                        ...
                        child: Container(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                    ...
                                    Container(
                                        ...
                                        Column(children:[
                                          ...
                                          Container(
                                              width: size.width/1.7,
                                              child: Text(
                                                  comunicados[index]["TITULO"].toString(),
                                                  maxLines: 2,
                                          ...
                                          Container(
                                              width: size.width/1.7,
                                              child: Text("Publicado el "+comunicados[index]["FECHAREGISTRO"].toString().substring(0,10),
                                                  maxLines: 2,
                                                  textAlign: TextAlign.left,
                              ...
                              SizedBox(height: 10,),
                              CachedNetworkImage(imageUrl: comunicados[index]["URL_IMG_PREVIA"].toString(), imageBuilder: (context, imageProvider) => Container(
                              ...
                              Container(
                                  ...
                                  child: Text(
                                      comunicados[index]["DESCRIPCION"].toString() == null || comunicados[index]["DESCRIPCION"].toString() == "" ? "" : comunicados[index]["DESCRIPCION"].toString().substring(0,100)+"...",
                                      maxLines: 2,
                                      textAlign: TextAlign.left,
