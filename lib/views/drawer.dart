...
abstract class DrawerContent extends StatefulWidget {
  VoidCallback? onMenuPressed;
}

class DrawerItem extends StatelessWidget {
  DrawerItem({this.onPressed, this.image, this.text, this.page});
...
class _HiddenDrawerState extends State<HiddenDrawer>
  ...
  void initState() {
    ...
    scaleAnimation =
        Tween<double>(begin: 1.0, end: 0.70).animate(animationController!);
    radiusAnimation = BorderRadiusTween(
        begin: BorderRadius.circular(0.0), end: BorderRadius.circular(25))
        .animate(
