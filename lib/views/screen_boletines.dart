...
class Boletines extends StatefulWidget {
  const Boletines({Key? key}) : super(key: key);

  @override
  _BoletinesState createState() => _BoletinesState();
}

class _BoletinesState extends State<Boletines> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: _getViewPagerStack(size, documentoHeight, documentoWidth,
            RevistasBoletines.listaBoletines));
  }
